...
const SlideShow = () => {
    ...
    return (
        <section className="min-h-screen bg-oxford-blue text-white flex flex-col items-center justify-center px-6 py-20">
            ...
            <div className="relative w-full max-w-3xl ibm-mono bg-black/20 backdrop-blur-2xl rounded-2xl p-10 shadow-xl transition-all duration-500">
                ...
                <div className="flex justify-between items-center mt-10">
                    ...
                    <button
                        onClick={prevSlide}
                        className="p-3 rounded-full bg-slate-700/20 hover:bg-slate-600/20 transition"
                    ><ChevronLeft />
                    </button>
